...
Run-Step $python @("-m", "PyInstaller", "--clean", "-y", "--noconsole", "--name", "AvtoVinchickTG", "--icon", "assets\AvtoVinchickTG.ico", "--add-data", "assets;assets", "--collect-all", "qt_material", "main.py")
